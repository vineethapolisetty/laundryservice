      ...
      <cfloop query="orders">
        <cfif dateFormat(EstimatedDeliveryDate, "yyyy-mm-dd") EQ todayStr>
          ...
          <div class="py-3 flex justify-between items-center">
            ...
            <a href="/laundryservice/index.cfm?fuse=agent_orderdetails&orderid=#encodeForURL(OrderID)#"
...
<body class="bg-gray-50 font-sans min-h-screen">
  ...
  <header class="bg-white p-4 shadow flex justify-between items-center">
    ...
    <a href="/laundryservice/index.cfm?fuse=agent_dashboard" class="text-blue-500 text-sm hover:underline">Back to Dashboard</a>
  </header>
  ...
  <footer class="fixed bottom-0 left-0 right-0 bg-white border-t border-gray-300 shadow-inner">
    <div class="flex justify-around h-14 items-center">
      <a href="/laundryservice/index.cfm?fuse=agent_dashboard" class="text-gray-600 flex flex-col items-center text-xs">
        <i class="ph ph-grid text-xl"></i>
        Dashboard
      </a>
      <a href="/laundryservice/index.cfm?fuse=agent_tracker" class="text-blue-600 flex flex-col items-center text-xs">
        <i class="ph ph-map-pin text-xl"></i>
        Tracker
      </a>
      <a href="/laundryservice/index.cfm?fuse=agent_profile" class="flex flex-col items-center text-xs text-gray-600">
  ...
  <script>
    ...
    function refreshTracker() {
      fetch('index.cfm?fuse=agent_tracker&ajax=1', { cache: 'no-store' })
        .then(r => r.text())

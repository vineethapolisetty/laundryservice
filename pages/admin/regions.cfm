...
<cfif structKeyExists(form, "actionType")>
    <cfif form.actionType EQ "add">
        ...
        <cflocation url="/laundryservice/index.cfm?fuse=admin_regions&message=Region added successfully" addtoken="no">
    ...
    <cfelseif form.actionType EQ "edit">
        ...
        <cflocation url="/laundryservice/index.cfm?fuse=admin_regions&message=Region updated successfully" addtoken="no">
    </cfif>
<cfelseif structKeyExists(url, "delete")>
    ...
    <cflocation url="/laundryservice/index.cfm?fuse=admin_regions&message=Region deleted successfully" addtoken="no">
</cfif>
...
<div class="container-fluid">
    <div class="row">
        ...
        <div class="col-md-2 bg-dark text-white p-4 min-vh-100">
            ...
            <ul class="nav flex-column mt-4">
                ...
                <li class="nav-item"><a class="nav-link text-white active" href="/laundryservice/index.cfm?fuse=admin_regions">Regions</a></li>
  ...
  <div class="card mb-4 shadow-sm">
    ...
    <div class="card-body">
      <form method="post" action="/laundryservice/index.cfm?fuse=admin_agents">
        <div class="row g-3">
                    ...
                    <table class="table table-bordered">
                        ...
                        <cfoutput query="regions">
                            <tr>
                                ...
                                <td>
                                    <a href="/laundryservice/index.cfm?fuse=admin_regions&delete=#RegionID#" class="btn btn-sm btn-danger" onclick="return confirm('Delete this region?')">Delete</a>
                                </td>
                            </tr>
                        </cfoutput>
                        </tbody>

...
<cfset orders = adminService.getOrderReports()>
    ...
    <div class="row">
      <div class="col-md-2 bg-dark text-white p-4 min-vh-100">
        ...
        <ul class="nav flex-column mt-4">
          ...
          <li class="nav-item"><a class="nav-link text-white active" href="/laundryservice/index.cfm?fuse=admin_admin_orders">Orders</a></li>
